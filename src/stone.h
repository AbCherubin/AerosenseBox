...
extern unsigned short STONE_RX_CNT, STONE_RX_CNT2;
...
// Call the example: set_video_play("0", "0", "01.mp4");
void set_video_play(char *_x, char *_y, char *_name);

// Call the example: set_audio_play("01.wav");
