...
volatile unsigned long Ab_WIEGAND::_cardTempHigh = 0;
volatile unsigned long Ab_WIEGAND::_cardTemp = 0;
volatile unsigned long Ab_WIEGAND::_lastWiegand = 0;
unsigned long Ab_WIEGAND::_code = 0;
volatile int Ab_WIEGAND::_bitCount = 0;
int Ab_WIEGAND::_wiegandType = 0;

Ab_WIEGAND::Ab_WIEGAND()
{
}

unsigned long Ab_WIEGAND::getCode()
{
	return _code;
}

int Ab_WIEGAND::getWiegandType()
{
	return _wiegandType;
}

bool Ab_WIEGAND::available()
{
	bool ret;
	noInterrupts();
...
void Ab_WIEGAND::begin()
{
	begin(2, 3);
}

void Ab_WIEGAND::begin(int pinD0, int pinD1)
{
	_lastWiegand = 0;
	_cardTempHigh = 0;
	_cardTemp = 0;
...
INTERRUPT_ATTR void Ab_WIEGAND::ReadD0()
{
...
INTERRUPT_ATTR void Ab_WIEGAND::ReadD1()
{
...
unsigned long Ab_WIEGAND::GetCardId(volatile unsigned long *codehigh, volatile unsigned long *codelow, char bitlength)
{
...
bool Ab_WIEGAND::DoWiegandConversion()
{
